<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewSupportInfo.aspx.cs" Inherits="WaiLianBuWeb.Student.NewSupportInfo" %>
<%--最新赞助信息页面--%>
<!DOCTYPE html>
...
<body>
    ...
    <div>
        <table>
            <tr>
                <td>
                    <asp:GridView ID="gvlist_NewSupportInfo" runat="server" AutoGenerateColumns="False" DataKeyNames="id" OnRowCommand="gvlist_NewSupportInfo_RowCommand" OnPageIndexChanging="gvlist_NewSupportInfo_PageIndexChanging" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%"  >
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="owner" DataTextField="username" HeaderText="商家名称" DataNavigateUrlFormatString="~/FrimSupport/FrimInfo.aspx?id={0}" HeaderStyle-Width="10%" HeaderStyle-Height="70px" ItemStyle-Width="10%" ItemStyle-Height="70px" />
